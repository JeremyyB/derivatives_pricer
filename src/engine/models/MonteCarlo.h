...
public:
    ...
    // By default, MTE_CARLO will be Naive Monte-Carlo, childs will be variance-reduction upgrades
    ...
    std::vector<double> simulatePaths(double S0, double r, double sigma) override;
